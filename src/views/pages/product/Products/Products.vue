...
<template>
    <div class="card">
        ...
        <Table title="Aquí podrás elegir las referencias que quieres ver" path-api="https://raw.githubusercontent.com/byepesg/TransformaMetrics/main/src/data/JSON6.json" @HeaderNames="onHeaderNames" @onRowSelect="RowSelect"  :dataMod="dataMod" />
